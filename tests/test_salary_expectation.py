...
def _answer(salary_text: str | None, is_numeric: bool, is_hourly: bool = False) -> str:
    ...
    fake_self = SimpleNamespace(
        ...
        HOURLY_SINGLE=BaseEasyApplier.HOURLY_SINGLE,
        HOURLY_RANGE_LOW=BaseEasyApplier.HOURLY_RANGE_LOW,
        HOURLY_RANGE_HIGH=BaseEasyApplier.HOURLY_RANGE_HIGH,
...
def test_hourly_numeric_single_value():
    assert _answer("No salary listed", is_numeric=True, is_hourly=True) == "30"


def test_hourly_range_field():
    assert _answer("No salary listed", is_numeric=False, is_hourly=True) == "28 - 35"
